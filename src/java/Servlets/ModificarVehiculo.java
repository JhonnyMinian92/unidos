 ...
 * @author lakeo
 */
@WebServlet(name = "ModificarVehiculo", urlPatterns = {"/actualauto"})
public class ModificarVehiculo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String resp = new Vehiculo().ActualizarVehiculo(propietario, tipo, dueno, chofer, placa, marca, modelo, anio, foto, fecha, clase, combustible, color, permiso);
